...
import logging
import open_clip
from ..utils import count_params, autocast
...
class FrozenCLIPT5Encoder(AbstractEncoder):
    def __init__(self, clip_version="openai/clip-vit-large-patch14", t5_version="google/t5-v1_1-xl", device="cuda",
        ...
        logging.info(f"{self.clip_encoder.__class__.__name__} has {count_params(self.clip_encoder)*1.e-6:.2f} M parameters, "
...
from .diffusionmodules.unet import Timestep
